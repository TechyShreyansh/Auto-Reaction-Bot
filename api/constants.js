...
✍️ To view the emojis I can use, simply type /reactions. To create your own auto reaction bot, head over to: [Auto-Reaction-Bot on GitHub](https://github.com/TechyShreyansh/Auto-Reaction-Bot).
...
<meta name="description" content="Tech Shreyansh presents an open-source Telegram Auto Reaction bot developed by Shreyansh. Reacts to all messages received from chats automatically. Serverless deployment on Cloudflare.">
<meta name="keywords" content="Telegram bot, auto reaction bot, open-source, Tech Shreyansh, Shreyansh, Telegram auto reaction, serverless telegram bot, reaction automation">
...
<button class="button githubBtn" onclick="window.location='https://github.com/TechyShreyansh/Auto-Reaction-Bot'">Open Source 🌱</button>

<div style="margin: 5px;">
  <a class="github-button" href="https://github.com/TechyShreyansh/Auto-Reaction-Bot" data-size="large" data-show-count="true">Star</a>
  <a class="github-button" href="https://github.com/TechyShreyansh/Auto-Reaction-Bot/fork" data-size="large" data-show-count="true">Fork</a>
</div>
<div>
  <a class="github-button" href="https://github.com/TechySHreyansh" data-size="large">Follow @Tech-Shreyansh</a>
</div>
</body>
</html>
`;
